...
//        shoppingCardButton = driver.findElement(By.cssSelector("#top-links > ul > li:nth-child(4) > a > i"));
        shoppingCardButton = driver.findElement(By.cssSelector("#top-links > ul > li:nth-child(4) > a"));
        System.out.println("shoppingCardButton = " + shoppingCardButton);
    ...
    public WebElement getShoppingCardButton() {
        return shoppingCardButton;
    }
    public String getShoppingCardButtonText(String attribute) {
        return getShoppingCardButton().getAttribute(attribute).trim();
    }
